        ...
        <Stack direction="column" sx={{width: "100%", height: "100%"}}>
            ...
            <div style={{display: "flex", flexDirection: "column", marginTop: "50px", padding: 3, gap: 3}}>
                ...
                {(contractSent || contractSaved || !isUserOwner || (contract.recipient && contract.ownerStage !== "DRAFT")) && (
                    <Box sx={{display:"flex", flexDirection: "column", justifyContent:"Space-around", gap:3, alignContent:"center" }}>
                        <Button variant="contained" onClick={handleCancel} sx={{
                            width: "100%",
                            backgroundColor: "rgb(185,67,102)",
                            '&:focus,&:active,&:hover': {
                        ...
                        {defaultTemplate === "true" && isUserOwner && (
                        <Button variant="contained" onClick={() => window.location.pathname="/contracts"} sx={{
                            width: "100%",
                            backgroundColor: "rgb(185,67,102)",
                            '&:focus,&:active,&:hover': {
                                backgroundColor: "rgb(185,67,102)"
